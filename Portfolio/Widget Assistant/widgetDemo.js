...
$(document).ready(function() { 
  ...
  // style.type = 'text/css';
  // style.innerHTML = '#everything { -webkit-transform: scale('+ratio+','+ratio+'); position:absolute; left:0px; -webkit-transform-origin: 0% 0%}';
  // document.getElementsByTagName('head')[0].appendChild(style);
  ratio = 1;
  topplacement = 50;
  $("#everything").width($("#weatherpanel").width()+$("#assistant").width());
  // $("#everyting").height(window.innerHeight);
  leftplacement = (window.innerWidth/2 - $("#everything").width()/2)*0.9;
  ...
  // $("#backgroundimg").css("top",-parseInt(topplacement)*width/320);

  $("#everything").css("left",leftplacement);
  $("#everything").css("top",topplacement);
  ...
  if (blur == true) {
    ...
    //         }
    // });
    $(".blur").attr("src","../Backgroundimg.jpg");
